...
import { InfoBackground } from "../assets/components/pages/Info/InfoBackground";
import { InfoSkills } from "../assets/components/pages/Info/InfoSkills";
...
export default function Info({ displayed_resume_experience }) {
  const router = useRouter();

  // Disable Index Page Links
  useEffect(() => {
    ManipPageLinks("disable", ".info-link");
  }, []);

  return (
    <div id="PAGE" className="page half-second overrides_Info">
      <HeadCnt
        title="codingthefront - Info/About"
        ...
        robots="index, follow"
        url="https://codingthefront.com/info/"
      />
      <DesktopNav />
      <MobileNav />
