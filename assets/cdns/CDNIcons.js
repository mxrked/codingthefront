...
const SQLALCHEMY = CDNIconReturn("programming-languages", "sqlalchemy", "webp");
const WIX = CDNIconReturn("programming-languages", "wix", "webp");
const EDITOR_X = CDNIconReturn("programming-languages", "editor-x", "webp");

export { FAVICON, FAVICON_16, FAVICON_32, ATI };
export { PYQT, PYTHON, SQL, SASS, NEXTJS, REACT, WIX, EDITOR_X, SQLALCHEMY };
